...
tmux send-keys -t $SESSION_NAME:0.2 'SUPERDUPERDB_CLUSTER_COMPUTE=ray://localhost:10001 SUPERDUPERDB_ARTIFACT_STORE=filesystem:///tmp/artifacts SUPERDUPERDB_DATA_BACKEND=mongodb://pinnacle:pinnacle@mongodb:27017/test_db SUPERDUPERDB_CLUSTER_CDC_URI=http://cdc:8001 SUPERDUPERDB_CLUSTER_VECTOR_SEARCH=http://vector-search:8000 python -m pinnacledb vector-search' C-m # Pane 2
tmux send-keys -t $SESSION_NAME:0.3 'SUPERDUPERDB_CLUSTER_COMPUTE=ray://localhost:10001 SUPERDUPERDB_ARTIFACT_STORE=filesystem:///tmp/artifacts SUPERDUPERDB_DATA_BACKEND=mongodb://pinnacle:pinnacle@mongodb:27017/test_db SUPERDUPERDB_CLUSTER_CDC_URI=http://cdc:8001 SUPERDUPERDB_CLUSTER_VECTOR_SEARCH=http://vector-search:8000 python -m pinnacledb cdc' C-m # Pane 2
