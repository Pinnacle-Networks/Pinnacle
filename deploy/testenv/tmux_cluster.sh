...
tmux send-keys -t $SESSION_NAME:0.2 "SUPERDUPERDB_CONFIG=$CFG python -m pinnacledb vector-search" C-m
tmux send-keys -t $SESSION_NAME:0.3 "SUPERDUPERDB_CONFIG=$CFG python -m pinnacledb cdc" C-m 
